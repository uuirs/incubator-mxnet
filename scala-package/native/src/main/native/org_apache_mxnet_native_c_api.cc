...
JNIEXPORT jint JNICALL Java_org_apache_mxnet_LibInfo_mxNDArrayCreateSparseEx
  ...
  int ret = MXNDArrayCreateSparseEx(storage_type, reinterpret_cast<mx_uint *>(shapeArr),
                              ...
                              reinterpret_cast<const mx_uint *>(auxShapeArr),
                              &out);
  env->ReleaseIntArrayElements(shape, shapeArr, 0);
...
JNIEXPORT jint JNICALL Java_org_apache_mxnet_LibInfo_mxNDArraySyncCopyFromCPU__J_3FI
...
JNIEXPORT jint JNICALL Java_org_apache_mxnet_LibInfo_mxNDArraySyncCopyFromCPU__J_3JI
